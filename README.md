...
> Status       : Online
> Role         : AI Engineering Practitioner / Full-Stack Developer
> Location     : China
> Philosophy   : Spec first. Automate deeply. Build for reality.
> Mode         : AI-native engineering / quant systems / relentless iteration
```
...
- Focused on **AI engineering落地**, **规范驱动开发**, and **workflow automation**
...
- Building with **TypeScript**, **React**, **Next.js**, **Node.js**, **Python**, and trading/automation ecosystems
...
### Languages
<img src="https://skillicons.dev/icons?i=ts,js,python,html,css,cpp,java,go,rust" />

### Frontend
<img src="https://skillicons.dev/icons?i=react,nextjs,vue,tailwind,vite,threejs" />

### Backend & Database
<img src="https://skillicons.dev/icons?i=nodejs,express,nestjs,prisma,mysql,postgres,mongodb,redis" />

### Tools & Platforms
<img src="https://skillicons.dev/icons?i=git,github,docker,vercel,cloudflare,vscode,figma,linux" />
...
> Public projects are pulled from your current GitHub profile focus and can be refined later into pinned flagship repositories.
...
focus:
  ...
  - real-time quantitative trading systems

currently_building:
  - AI agile development workflows
  - full-process automation pipelines
  - trading and intelligent tooling experiments

mindset:
  - automate what matters
  - measure the whole flow
  - build systems that can ship repeatedly
```
